   ...
   public class AmayaTabControl : TabControl
    {
        ...
        protected override void OnMouseMove(MouseEventArgs e)
{
   ...
   protected override void OnCreateControl()
        {
             foreach (TabPage Tab in base.TabPages)
            {
                Tab.BackColor=Color.FromArgb(38, 38, 38);
            }
       ...
       Bitmap B = new Bitmap(Width, Height);
         using (Graphics G   = Graphics.FromImage(B))
         {
                ...
                for (int i = 0; i <= TabPages.Count - 1; i++)
                {
                    ...
                    if (!(ImageList == null))
                    { G.DrawImage(ImageList.Images[i], new Rectangle(R.X + 12, R.Y + 11, 16, 16)); }
   ...
   public class AmayaUniqueTabControl : TabControl
   {
       ...
       protected override void OnPaint(PaintEventArgs e)
       {
           ...
           using (Graphics G = Graphics.FromImage(B))
           {
               ...
               for (int i = 0; i <= TabPages.Count - 1; i++)
               {
                   ...
                   if (i == SelectedIndex)
                   {
                       G.FillRectangle(new SolidBrush(Color.FromArgb(27, 27, 27)), new Rectangle(R.X - 1, R.Y, R.Width + 1, R.Height)); ;
                   ...
                   else
                   {
                       if (State.Hover & R.Contains(State.Coordinates))
                       {
                           ...
                           G.FillRectangle(new SolidBrush(Color.FromArgb(28, 28, 28)), new Rectangle(R.X-1, R.Y, R.Width + 1, R.Height));
                   ...
                   if (!(ImageList == null))
                   { G.DrawImage(ImageList.Images[i], new Rectangle(R.X + 14, R.Y + 11, 16, 16)); }
               ...
               G.DrawLine(new Pen(Color.FromArgb(35, 35, 35), 2), ItemSize.Height + 3, 0, ItemSize.Height + 3, Height);
